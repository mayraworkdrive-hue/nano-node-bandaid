...
### notes: 
### 1. if the filename is listed multiple times in the input file, its because the replacement must be ran multiple times.
### 2. order is important. sometimes Nano is Banano but Nanocurrency is 
